...
class ChartsPanel(QWidget):
    ...
    def start_processing_monitoring(self):
        ...
        print("🚀 Charts Panel: Start snelle monitoring...")
        ...
        if hasattr(self, 'gpu_monitor'):
            ...
            print("✅ GPU Monitor: Verwerking gestart")
    ...
    def stop_processing_monitoring(self):
        ...
        print("🛑 Charts Panel: Stop snelle monitoring...")
        ...
        if hasattr(self, 'gpu_monitor'):
            ...
            print("✅ GPU Monitor: Verwerking gestopt")
    ...
    def _try_connect_monitors(self):
        ...
        if main_window:
            ...
            print(f"✅ GPU Monitor gekoppeld aan hoofdvenster: {main_window}")
        else:
