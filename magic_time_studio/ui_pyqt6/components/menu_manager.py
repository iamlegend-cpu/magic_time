...
class MenuManager(QObject):
    ...
    # Signals
    add_file_triggered = pyqtSignal()
    add_folder_triggered = pyqtSignal()
    ...
    cuda_test_triggered = pyqtSignal()
    whisper_diagnose_triggered = pyqtSignal()
    test_completed_files_triggered = pyqtSignal()
    theme_changed = pyqtSignal(str)
    exit_triggered = pyqtSignal()
    show_charts_triggered = pyqtSignal()
    show_batch_triggered = pyqtSignal()
