"""
UI Manager voor Magic Time Studio PyQt6
...
class UIManager:
    ...
    def _set_application_icon(self):
        ...
        try:
            # Bepaal project root - probeer verschillende paden
            current_file = os.path.abspath(__file__)
            possible_roots = [
                os.path.dirname(os.path.dirname(current_file)),  # app_core -> magic_time_studio
                os.path.dirname(os.path.dirname(os.path.dirname(current_file))),  # app_core -> magic_time_studio -> magic_time
                os.path.join(os.path.dirname(current_file), "..", ".."),  # Relatief pad
            ]
