#!/usr/bin/env python3
"""
Eenvoudige test om te controleren wat er gebeurt met de transcript_result na Fast Whisper
"""
...
def test_transcript_result_check():
    """Test wat er gebeurt met de transcript_result"""
    print("🔍 [DEBUG] Transcript Result Check Test")
    print("=" * 50)
    ...
    try:
        ...
        if isinstance(transcript_result, dict):
            print(f"  📊 Transcript result keys: {list(transcript_result.keys())}")
...
if __name__ == "__main__":
    ...
    success = test_transcript_result_check()
