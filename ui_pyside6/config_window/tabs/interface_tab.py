...
class InterfaceTab(QWidget):
    ...
    def setup_ui(self):
        ...
        self.completed_files_panel_check = QCheckBox("✅ Voltooide Bestanden Panel")
        panels_layout.addWidget(self.completed_files_panel_check)
    ...
    def load_configuration(self):
        ...
        try:
            ...
            self.completed_files_panel_check.setChecked(config_manager.is_panel_visible("completed_files_panel"))
    ...
    def save_configuration(self):
        ...
        try:
            ...
            config_manager.set_panel_visibility("completed_files_panel", self.completed_files_panel_check.isChecked())
